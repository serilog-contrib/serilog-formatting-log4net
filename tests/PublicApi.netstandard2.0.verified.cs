...
namespace Serilog.Formatting.Log4Net
{
    ...
    public class Log4NetTextFormatter : Serilog.Formatting.ITextFormatter
    {
        ...
        public Log4NetTextFormatter(string? formatProvider = null, Serilog.Formatting.Log4Net.CDataMode? cDataMode = default, string? nullText = "$Serilog.Formatting.Log4Net.Log4NetTextFormatter.nullText$", bool noNullText = false, bool noXmlNamespace = false, Serilog.Formatting.Log4Net.LineEnding? lineEnding = default, string? indentation = null, bool log4JCompatibility = false) { }
